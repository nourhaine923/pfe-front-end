...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (errorMessage.toLowerCase().includes("email") && errorMessage.toLowerCase().includes("not found")) {
        ...
        showToast(errorMessage || "Login failed", "error")
      }
    } finally {
      setIsLoading(false)
    }
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      if (errorMessage.toLowerCase().includes("already") && 
          (errorMessage.toLowerCase().includes("exist") || errorMessage.toLowerCase().includes("registered"))) {
        ...
        showToast("Email already exists. Try a different email or sign in.", "error")
        ...
        showToast(errorMessage || "Signup failed ", "error")
      }
    } finally {
      setIsLoading(false)
    }
  ...
  return (
     <div 
    className="login-page min-h-screen flex items-center justify-center font-sans p-4 bg-cover bg-center bg-no-repeat"
    style={{
      ...
      <div 
        className={`container relative bg-white rounded-[30px] shadow-[0_5px_15px_rgba(94,94,94,0.35)] overflow-hidden w-[768px] max-w-full min-h-[560px] ${
          isActive ? 'active' : ''
        }`} 
        id="container"
      >
        ...
        <div className={`form-container absolute top-0 h-full transition-all duration-600 ease-in-out left-0 w-1/2 ${
          ...
          >
            <h1 className="text-2xl font-bold mb-6">Create Account</h1><br/>
            
            <div className="social-icons flex gap-3 mb-6">
              <a href="#" className="icons border border-gray-300 rounded-full inline-flex justify-center items-center w-10 h-10 hover:bg-gray-100 transition-colors">
            ...
            <div className="w-full max-w-[280px] space-y-4"><br/>
              <input 
                ...
                disabled={isLoading}
                className="w-full bg-gray-100 border-none px-5 py-3 text-sm rounded-xl outline-none focus:ring-2 focus:ring-blue-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              /><div/><br/>
            ...
            <div className="w-full max-w-[280px] space-y-4 mt-4">
              <select
                ...
                disabled={isLoading}
                className="w-full bg-gray-100 border-none px-5 py-3 text-sm rounded-xl outline-none focus:ring-2 focus:ring-blue-500 transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="mt-8 bg-blue-600 text-white text-base font-semibold px-10 py-4 rounded-xl tracking-wide uppercase hover:bg-blue-700 hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg min-w-[200px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
        ...
        <div className={`form-container absolute top-0 h-full transition-all duration-600 ease-in-out left-0 w-1/2 ${
          ...
          >
            <h1 className="text-2xl font-bold mb-6">Sign In</h1><br/>
            ...
            <a href="#" className="text-gray-500 text-xs mt-4 hover:text-blue-600 transition-colors">
              Forgot Password?
            </a><br/>
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="mt-6 bg-blue-600 text-white text-base font-semibold px-10 py-4 rounded-xl tracking-wide uppercase hover:bg-blue-700 hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg min-w-[200px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
        ...
        <div className={`toggle-container absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-all duration-600 ease-in-out rounded-[30px] z-[1000] ${
          ...
          <div className={`toggle bg-gradient-to-br from-blue-600 to-blue-700 h-full text-white relative -left-full h-full w-[200%] transition-all duration-600 ease-in-out ${
            ...
            <div className={`toggle-panel absolute w-1/2 h-full flex items-center justify-center flex-col px-10 text-center top-0 transition-all duration-600 ease-in-out ${
              ...
              <button 
                ...
                disabled={isLoading}
                className="mt-4 bg-transparent text-white text-base font-semibold px-10 py-4 border-2 border-white rounded-xl tracking-wide uppercase hover:bg-white hover:text-blue-600 transition-all duration-300 min-w-[180px] disabled:opacity-50 disabled:cursor-not-allowed"
                id="login"
              >
                Sign In
              </button>
